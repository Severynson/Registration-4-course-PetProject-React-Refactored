...
const features = [
  ...
  },
  {
    ...
    name: "Recording",
    description: "If you didn't have possibility to connect... You can watch record"
  },
];

const CourseFeatures = () => {
  const mapFunc = (featureObj) => {
    return (
      <FeatureCard
        featureIcon={featureObj.svg}
  ...
  return (
    <div className={classes["cards-container"]}>{features.map(mapFunc)}</div>
  );
};
